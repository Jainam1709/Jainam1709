...
I'm a Cloud Engineer with 2+ years of experience designing and automating production infrastructure on AWS and Azure. Most recently, I worked as an IT Cloud Extern at ALSAC / St. Jude Children's Research Hospital, monitoring production workloads and supporting cost optimization for the enterprise IT team.

I specialize in:

- **Infrastructure-as-Code and cloud automation** with Terraform across AWS and Azure
- **Container orchestration and CI/CD** with Kubernetes, Docker, EKS/ECS, and GitHub Actions
...
**Cloud:** AWS (EC2 • S3 • Lambda • RDS • IAM • API Gateway • CloudWatch) • Azure (VMs • VNets • AKS)
**Infrastructure & DevOps:** Terraform • Docker • Kubernetes • Jenkins • GitHub Actions • Linux
**Generative AI:** Amazon Bedrock • RAG • FAISS • LLM APIs
**Data & Monitoring:** Apache Airflow • Power BI • Grafana • CloudWatch
**Databases:** PostgreSQL • MySQL • AWS RDS • DynamoDB • MongoDB
...
Fully serverless RAG pipeline using Lambda, API Gateway, and Bedrock, with FAISS indexing 1,500+ document chunks in S3.
...
- 💻 GitHub: [github.com/Jainam1709](https://github.com/Jainam1709)
- 💼 LinkedIn: [linkedin.com/in/jainam17](https://www.linkedin.com/in/jainam17/)
